                ...
                <form>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        ...
                        <div className="my-2 w-1/2 lg:w-2/4">
                            <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-gray-500 hover:bg-blue-900 text-gray-100 p-3 rounded-lg w-full cursor-pointer focus:outline-none focus:shadow-outline" disabled>
                                Send Message
                            </button>
                        </div>
                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 1234567890</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">deepgavat@gmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                                <div className="rounded-full cursor-pointer flex justify-center bg-white h-8 text-blue-900 w-8 mx-1 text-center pt-1">
